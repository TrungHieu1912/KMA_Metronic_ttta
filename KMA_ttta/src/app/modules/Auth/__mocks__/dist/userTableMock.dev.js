...
var _helpers = require("../../../../_metronic/_helpers");
...
var _default = [{
  ...
  roles: [1],
  // Administrator
  pic: (0, _helpers.toAbsoluteUrl)("/media/users/300_25.jpg"),
  fullname: "Hiếu",
  occupation: "CEO",
  ...
  roles: [2],
  // Manager
  pic: (0, _helpers.toAbsoluteUrl)("/media/users/100_2.jpg"),
  fullname: "Megan",
  ...
  roles: [3],
  // Guest
  pic: (0, _helpers.toAbsoluteUrl)("/media/users/default.jpg"),
