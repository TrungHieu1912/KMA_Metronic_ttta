            ...
            >
              ...
              <div className="d-flex flex-row-fluid flex-column justify-content-between">
                ...
                <div className="flex-column-fluid d-flex flex-column justify-content-center" >
                  <h2 className="font-size-h1 mb-5 text-black">
                    Welcome to Trung tâm Ngoại ngữ KMA !
                  </h2>
                  <p className="font-weight-lighter text-black opacity-80">
                  Trung tâm Ngoại ngữ KMA - Học viện Kỹ thuật Mật mã<br></br>
                  Nơi nâng tầm bút chì 2B của bạn 
                  </p>
                </div>
                {/* end:: Aside content */}
